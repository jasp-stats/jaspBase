...
JASP_OBJECT_CREATOR_ARG(jaspColumn, computed)
...
RCPP_MODULE(jaspResults)
{
	...
	Rcpp::class_<jaspPlot_Interface>("jaspPlot")
		...
		.property("export",			&jaspPlot_Interface::getExport,			&jaspPlot_Interface::setExport,			"Machine-readable context tagged onto this plot.")
